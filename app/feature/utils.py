...
def update_featured_story(
    featured_story, left_right, title, is_visible, description, rank
):
    """
    ...
    :return: None
    """
    featured_story_fields = {"left_right", "is_visible", "title", "description", "rank"}
...
def hide_current_featured_story(story_id):
    ...
    featured_story = FeaturedStories.query.filter_by(
        story_id=story_id, is_visible=True
    ).one_or_none()
