...
def create_story(
    ...
    story = Stories(
        activist_first=activist_first.title(),
...
def create_user(user_first, user_last, user_email, user_phone, subscription):
    """
    ...
    # Create Events object
    create_object(
        Events(_type=USER_CREATED, user_guid=user.guid, new_value=user.val_for_events)
    )
    return user.guid
