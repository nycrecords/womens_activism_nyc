...
class StoryForm(Form):
    ...
    content = TextAreaField("Share a few words about how your woman activist has inspired you and others",
                            validators=[DataRequired()], id="her-story-text")
    ...
    image_url = StringField("Enter an image URL below", validators=[Optional(), validate_image], id="image-url")
    video_url = StringField("Enter a YouTube or Vimeo URL below", validators=[Optional(), validate_video],
                            id="video-url")
    poster_first = StringField("User first name", validators=[Optional(), Length(1, 64)], id="user-first-name-field")
    poster_last = StringField("User last name", validators=[Optional(), Length(1, 64)], id="user-last-name-field")
    poster_email = StringField("User email", validators=[Optional(), Email(), Length(1, 254)], id="user-email-field")
