...
from app.stories import validators
...
class StoryForm(Form):
    ...
    content = TextAreaField("Share a few words about how your woman activist has inspired you and others",
                            validators=[DataRequired(), Length(1, 5000)],
    ...
    activist_url = StringField("Enter a URL to allow others to learn more about your woman activist online",
                               validators=[Optional(), Length(1, 254), validators.validate_url]
    ...
    video_url = StringField("Enter a YouTube or Vimeo URL below", validators=[Optional(), validators.validate_video])
    poster_first = StringField("Poster first name", validators=[Optional(), Length(1, 30), validators.validate_name],
                               render_kw={"placeholder": "Mary"})
    poster_last = StringField("Poster last name", validators=[Optional(), Length(1, 30), validators.validate_name],
                              render_kw={"placeholder": "Smith"})
