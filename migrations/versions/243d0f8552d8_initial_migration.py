...
def upgrade():
    ...
    op.create_table('events',
                    ...
                    sa.Column('type', sa.Enum('story_created', 'user_created', 'story_edited', 'story_deleted',
                                              'comment_edited', 'comment_deleted', 'feature_story_added',
                                              'feature_story_edited', 'feature_story_deleted',
                                              'then_and_now_edited', 'story_flagged', 'user_edited', 'login_failed',
                                              'login_success', name='event_type'),
                              nullable=False),
                    sa.Column('timestamp', sa.DateTime(), nullable=False),
